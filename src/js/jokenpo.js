function jogar() {
    if (document.getElementById("pedra").checked == false && document.getElementById("papel").checked == false && document.getElementById("tesoura").checked == false) {
        ...
        switch (sorteio) {
            case 0:
                document.getElementById("pc").src = "src/img/pcpedra.png";
                break;
            case 1:
                document.getElementById("pc").src = "src/img/pcpapel.png";
                break;
            case 2:
                document.getElementById("pc").src = "src/img/pctesoura.png";
                break;
        }
...
function resetar() {
    document.getElementById("pc").src = "src/img/pc.png";
